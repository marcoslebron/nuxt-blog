  ...
  methods: {
    ...
    openSharer(network, url) {
      ...
      this.popup.window = window.open(
        url,
        "sharer",
        `status=${this.popup.status ? "yes" : "no"},height=${
          this.popup.height
        },width=${this.popup.width},resizable=${
          this.popup.resizable ? "yes" : "no"
        },left=${this.popup.left},top=${this.popup.top},screenX=${
          this.popup.left
        },screenY=${this.popup.top},toolbar=${
          this.popup.toolbar ? "yes" : "no"
        },menubar=${this.popup.menubar ? "yes" : "no"},scrollbars=${
          this.popup.scrollbars ? "yes" : "no"
        },location=${this.popup.location ? "yes" : "no"},directories=${
